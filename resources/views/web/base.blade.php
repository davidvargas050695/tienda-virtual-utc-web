...
<head>
    ...
    <link href="{{asset('client/vendor/animate.css/animate.min.css')}}" rel="stylesheet">
    <link href="{{asset('client/vendor/venobox/venobox.css')}}" rel="stylesheet">
    <link href="{{asset('client/vendor/owl.carousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
...
<script src="{{asset('client/vendor/jquery-sticky/jquery.sticky.js')}}"></script>
...
<script src="{{asset('client/vendor/waypoints/jquery.waypoints.min.js')}}"></script>
